          ...
          <ScrollView style={{ padding: 20 }}>
            ...
            {presets.length > 0 && (
              <>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 12 }}>
                  {presets.map((p: any) => (
                    <PunyTouchable key={p.id} onPress={() => applyPreset(p)} scaleTo={0.95} haptic="light"
...
const styles = StyleSheet.create({
  ...
  monthBtn:      { padding: 6 },
  monthLabel:    { fontSize: 14, color: '#eeeeff', fontWeight: '600', minWidth: 80, textAlign: 'center' },
  ...
  castAvatar:    { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(170,136,255,0.15)', justifyContent: 'center', alignItems: 'center' },
