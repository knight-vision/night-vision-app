    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <View style={styles.inner}>
        ...
        <View style={styles.form}>
          ...
          <TextInput style={styles.input} placeholder="パスワード" placeholderTextColor={Colors.text3}
...
const styles = StyleSheet.create({
  ...
  logoText:     { fontSize: 20, fontWeight: '600', color: Colors.gold, letterSpacing: 2 },
  form:         { width: '100%', gap: 12 },
  input:        { backgroundColor: Colors.surface, borderRadius: 12, borderWidth: 0.5, borderColor: Colors.border, paddingHorizontal: 14, height: 50, color: Colors.text, fontSize: 14 },
  errorText:    { color: Colors.red, fontSize: 12, textAlign: 'center' },
  loginBtn:     { backgroundColor: Colors.gold, borderRadius: 12, height: 50, justifyContent: 'center', alignItems: 'center' },
  loginBtnText: { color: '#1a1200', fontSize: 15, fontWeight: '600' },
});
